                ...
                <div class="panel-body">
                    <div class="col-md-2 col-sm-4 col-xs-4">
                        <img alt="User Pic"
                             ...
                             @endif" class="img-circle img-responsive">
                        <button type="button" data-toggle="modal" data-target="#imageMo"
                                class="btn btn-link fa-border center-block" style="margin-top: 5px">edit avatar
                        </button>
                            ...
                            <div class="modal fade" id="imageMo" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="post" action="{{route('user_image',['id' => $user->id])}}"
                    ...
                    <div class="col-md-10 col-sm-8 col-xs-8">
                        <form class="form-horizontal" action="{{route('user_edit',['id' => $user->id])}}" method="post"
                              enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            <fieldset>
                                ...
                                red">*</strong></label>
                                    <div class="col-md-10">
                                        <select class="form-control" name="type_account" id="select-1">
                                            <option value="1"
                                            @if(old('type_account')) {{old('type_account') == '1'?'selected':''}} @elseif($user->type_account == '1') {{'selected'}} @endif >
                                                Writer
                                            </option>
                                            <option value="2" @if(old('type_account')){{old('type_account') == '2'?'selected':''}}@elseif($user->type_account == '2'){{'selected'}}@endif>
                                                Viewer
                                            </option>
                                            <option value="3" @if(old('type_account')){{old('type_account') == '3'?'selected':''}}@elseif($user->type_account == '3'){{'selected'}}@endif>
                                                Limit
                                            </option>
                                        </select>
