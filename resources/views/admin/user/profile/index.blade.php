        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading" style="padding: 5px 15px 20px 15px">
                    <p class="panel-title"><i class="glyphicon glyphicon-credit-card"></i> Your Profile</p>
                </div>
                ...
                <div class="panel-footer">
                    <a href="{{route('dashboard')}}" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-home"></i> Home</a>
                    <span class="pull-right">
                        <a type="button" class="btn btn-sm btn-warning" href="{{route('profile_edit')}}"><i class="glyphicon glyphicon-edit"></i> edit</a>
                    </span>
                </div>
            </div>
        </div>
