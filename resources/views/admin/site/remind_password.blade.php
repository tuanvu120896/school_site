...
<html>
<head>
    <title>remind password - admin site</title>
            ...
            <div class="login-wrapper">
                <div class="box">
                    ...
                    <div class="content-wrap">
                        <form method="post" action="{{route('remind_password')}}">
                            <input name="_token" type="hidden" value="{{csrf_token()}}"/>
                            <i class="left">Please enter your email used to register to get password, </i>
                            <input class="form-control" name="email" type="text"
                                   placeholder="E-mail address">
                            <div class="action">
                                <button type="submit" class="btn btn-primary signup">Get Password</button>
                            </div>
                        </form>
                    </div>
                </div>
