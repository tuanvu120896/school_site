...
@section('title')
    {{ucwords('thêm thông tin khác về trường')}} - admin {{config('global.site')}}
@endsection
@section('style')
        ...
        <div class="col-md-12">
            <div class="content-box-large">
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('school_add_info',['id' => $id_school])}}" method="post"
                          enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <fieldset>
                            <legend>{{ucwords('thêm thông tin khác về trường')}}</legend>
                            <div class="col-md-12">
                                @if(Session::has('msg'))
                                    {!! Session::get('msg') !!}
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <input class="form-control" value="{{old('dorm_status')}}" name="dorm_status"
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <input class="form-control" value="{{old('dorm_money')}}" name="dorm_money"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" placeholder="hướng dẫn nghề nghiệp"
                                              name="career">{{old('career')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <input class="form-control" placeholder="công việc làm thêm" type="text" name="overtime"
                                           value="{{old('overtime')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" placeholder="trạng thái"   name="about">{{old('about')}}</textarea>
                                    @if($errors->has('about'))
                                        <span style="color:red;">
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <textarea class="form-control" placeholder="tình hình học tiếng nhật"  name="japanese">{{old('japanese')}}</textarea>
