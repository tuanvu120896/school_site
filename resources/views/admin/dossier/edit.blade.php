...
@section('title')
    thay đổi tin tức về làm hồ sơ - {{config('global.site')}}
@endsection
        ...
        <div class="col-md-12">
            <div class="content-box-large">
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('dossier_edit',['id' => $dossier['id']])}}" method="post"
                        ...
                        <fieldset>
                                ...
                                <div class="col-md-10">
                                    <select class="form-control status" name="status" id="status">
                                        <option value="1"
                                                ...
                                                @if(!old('status') && $dossier['status'] == 1 ) selected @endif >
                                            bản nháp</option>
                                        <option value="0"
                                                @if(old('status') && old('status') == 0 ) selected @endif
                                                @if(!old('status') && $dossier['status'] == 0 ) selected @endif >
                                            public</option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <input class="form-control" value="{{old('name')?old('name'):$dossier['name']}}" name="name"
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <textarea name="about" class="form-control">{{old('about')?old('about'):$dossier['about']}}</textarea>
                                    @if($errors->has('about'))
                                        <span style="color:red;">
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <textarea name="body" id="text-body" class="form-control">{{old('body')?old('body'):$dossier['body']}}</textarea>
                                    @if($errors->has('body'))
                                        <span style="color:red;">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                ...
                                <div class="col-md-10 col-lg-push-2">
                                    ...
                                    <a  class="btn btn-danger" type="button" href="{{url(route('dossier_list'))}}">
                                        <i class="fa fa-save"></i>
                                        Hủy Bỏ
                                    </a>
                                </div>
