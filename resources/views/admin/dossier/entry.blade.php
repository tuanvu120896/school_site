        ...
        <div class="col-md-12">
            <div class="content-box-large">
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('dossier_entry')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control status" name="status" id="status">
                                        <option value="1" selected @if(old('status') && old('status') == 1) selected @endif > bản nháp</option>
                                        <option value="0" @if(old('status') && old('status') == 0) selected @endif > public</option>
                                    </select>
