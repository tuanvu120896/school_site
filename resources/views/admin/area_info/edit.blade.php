...
@section('title')
    thay đổi tin tức về các vùng- {{config('global.site')}}
@endsection
        ...
        <div class="col-md-12">
            <div class="content-box-large">
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('area_info_edit',['id' => $area_info['id']])}}" method="post"
                          enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <fieldset>
                            <legend><i class="glyphicon glyphicon-edit"></i> {{ucwords('chỉnh sửa bài viết')}}</legend>
                            <div class="col-md-12">
                                @if(Session::has('msg'))
                                    {!! Session::get('msg') !!}
                                @endif
                                ...
                                <div class="col-md-10">
                                    <select class="form-control status" name="status" id="status">
                                        <option value="1"
                                                ...
                                                @if(!old('status') && $area_info['status'] == 1 ) selected @endif >
                                            bản nháp</option>
                                        <option value="0"
                                                @if(old('status') && old('status') == 0 ) selected @endif
                                                @if(!old('status') && $area_info['status'] == 0 ) selected @endif >
                                            public</option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <input class="form-control" value="{{old('name')?old('name'):$area_info['name']}}" name="name"
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <textarea name="about" class="form-control">{{old('about')?old('about'):$area_info['about']}}</textarea>
                                    @if($errors->has('about'))
                                        <span style="color:red;">
                            ...
                            <div class="form-group">
                                ...
                                red">*</strong></label>
                                <div class="col-md-10">
                                    <textarea name="body" id="txt-body" class="form-control">{{old('body')?old('body'):$area_info['body']}}</textarea>
                                    @if($errors->has('body'))
                                        <span style="color:red;">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                ...
                                <div class="col-md-10 col-lg-push-2">
                                    ...
                                    <a  class="btn btn-danger" type="button" href="{{url(route('area_info_list'))}}">
                                        <i class="fa fa-save"></i>
                                        Hủy Bỏ
                                    </a>
                                </div>
