        ...
        <div id="content" class="site-content">
            <div id="primary" class="content-area">
                <main id="main" class="site-main" role="main">
                    <div style="color: red;text-align: center; height: 100px; margin-top: 30px">
                        Sory : error 404 - page not found ! <br>
                        <a href="{{url(route('front_home'))}}" style="color: #079b9b;text-decoration: underline">back to search other information</a>
                    </div>
                </main><!-- #main -->
            </div><!-- #primary -->
        </div><!-- #content -->
            ...
            <div class="frame">
                <ul id="pan" class="clearfix">
                    <li id="home"><a href="{{url(route('front_home'))}}"><img alt="ホーム"
                                                                              ...
                                                                              width="16" height="14"
                                                                              class="over"></a></li>
                    <li>Search Japanese language school</li>
                </ul>
                <!-- //▼CONTENT▼// -->
                            ...
                            @foreach($localities as $locality)
                                <div class="item">
                                    ...
                                    <p style="margin-left: 10px">
                                        <strong>Area:</strong>
                                        <a href="#" style="color: #079b9b">{{$locality->name}}</a>
                                    </p>
                                </div>
                            @endforeach

                        </div>
                        <h3 style="color: red;margin-top: 10px;text-align: center">
                            Sorry : error 404 - page not found ! <a href="{{url(route('front_home'))}}" style="color: #079b9b">find other school</a>
                        </h3>
                    </div>
                    <!-- //△MAIN AREA△// -->
