                    ...
                    <div class="category-box hoc-tieng-nhat clearfix">
                        ...
                        <div id="main-list" style="margin-top: 5px">
                            @foreach($area_info as $item)
                                <div id="item"
                                    ...
                                    <div id="text-title" style="float: left;width: 35%;height: 100px;">
                                        <a href="{{url(route('front_area_info_detail',['name' => $item->title]))}}"><img src="{{url('asset/image/icon/area_info/'.$item->image)}}"
                            ...
                            <div style="margin-top: 5px; padding-bottom: 15px;width: 100%;height: auto; ">
                                @if($area_info->previousPageUrl() !== NULL)
                                    <div style="float: left;">
                                        <a style="color:#079b9b;border: 1px solid #ddd;padding: 6px;border-radius: 5px;text-decoration: none;{{$area_info->previousPageUrl() == NULL?'pointer-events: none;color:#ccc':''}}"
                                           href="{{ $area_info->previousPageUrl() }}">Trang Trước</a>
                                    </div>
                                @endif
                                @if($area_info->nextPageUrl() !== NULL)
                                    <div style="float: right;">
                                        <a style="color:#079b9b;border: 1px solid #ddd;padding: 6px;border-radius: 5px;text-decoration: none;{{$area_info->nextPageUrl() == NULL?'pointer-events: none;color:#ccc':''}}"
                                           href="{{$area_info->nextPageUrl()}}">Trang Sau</a>
                                    </div>
                                @endif
                            </div>
                        </div>
        ...
        <div id="container">
            <div class="frame">
                <ul id="pan" class="clearfix">
                    ...
                    <li>Thông Tin Về Các Vùng Ở Nhật</li>
                </ul>
                <!-- //▼CONTENT▼// -->
                            ...
                            <div id="mainBox">
                                @foreach($area_info as $item)
                                    <div id="item"
                                        ...
                                        <div style="float: left;width: 40%;height: 160px;">
                                            <a href="{{url(route('front_area_info_detail',['name' => $item->title]))}}"><img src="{{url('asset/image/icon/area_info/'.$item->image)}}" width="100%"
                                                 height="150"  style="border: 1px solid #e3e3e3"></a>
                                        </div>
                                        <div style="float: left;height: 160px; width: 60%;">
                                            <a href="{{url(route('front_area_info_detail',['name' => $item->title]))}}"><h1
                                ...
                                <div style=" padding-bottom: 15px;width: 100%;height: auto; ">
                                    <div style=" padding-bottom: 15px;width: 100%;height: auto; ">
                                        @if($area_info->previousPageUrl() !== NULL)
                                            <div style="float: left;">
                                                <a style="border: 1px solid #ddd;padding: 6px;border-radius: 5px;text-decoration: none;{{$area_info->previousPageUrl() == NULL?'pointer-events: none;color:#ccc':''}}"
                                                   href="{{ $area_info->previousPageUrl() }}">Trang Sau</a>
                                            </div>
                                        @endif
                                        @if($area_info->nextPageUrl() !== NULL)
                                            <div style="float: right;">
                                                <a style="border: 1px solid #ddd;padding: 6px;border-radius: 5px;text-decoration: none;{{$area_info->nextPageUrl() == NULL?'pointer-events: none;color:#ccc':''}}"
                                                   href="{{$area_info->nextPageUrl()}}">Trang Tiep</a>
                                            </div>
                                        @endif
                                    </div>
                                </div>
